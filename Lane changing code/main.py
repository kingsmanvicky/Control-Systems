...
time_length=constants['time_length'] # duration of the maneuver
...
statesTotal=np.zeros((len(t),len(states))) # It will keep track of all your states during the entire maneuver
...
def update_plot(num):
    ...
    car_1.set_data([X_ref[num]-lr*np.cos(statesTotal[num,1]),X_ref[num]+lf*np.cos(statesTotal[num,1])],[statesTotal[num,3]-lr*np.sin(statesTotal[num,1]),statesTotal[num,3]+lf*np.sin(statesTotal[num,1])])


    car_1_body.set_data([-lr*np.cos(statesTotal[num,1]),lf*np.cos(statesTotal[num,1])],[-lr*np.sin(statesTotal[num,1]),lf*np.sin(statesTotal[num,1])])


    car_1_body_extension.set_data([0,(lf+40)*np.cos(statesTotal[num,1])],[0,(lf+40)*np.sin(statesTotal[num,1])])


    car_1_back_wheel.set_data([-(lr+0.5)*np.cos(statesTotal[num,1]),-(lr-0.5)*np.cos(statesTotal[num,1])],[-(lr+0.5)*np.sin(statesTotal[num,1]),-(lr-0.5)*np.sin(statesTotal[num,1])])


    car_1_front_wheel.set_data([lf*np.cos(statesTotal[num,1])-0.5*np.cos(statesTotal[num,1]+UTotal[num]),lf*np.cos(statesTotal[num,1])+0.5*np.cos(statesTotal[num,1]+UTotal[num])],[lf*np.sin(statesTotal[num,1])-0.5*np.sin(statesTotal[num,1]+UTotal[num]),lf*np.sin(statesTotal[num,1])+0.5*np.sin(statesTotal[num,1]+UTotal[num])])


    car_1_front_wheel_extension.set_data([lf*np.cos(statesTotal[num,1]),lf*np.cos(statesTotal[num,1])+(0.5+40)*np.cos(statesTotal[num,1]+UTotal[num])],[lf*np.sin(statesTotal[num,1]),lf*np.sin(statesTotal[num,1])+(0.5+40)*np.sin(statesTotal[num,1]+UTotal[num])])
    ...
    if Pid_switch!=1:
        return car_1, car_1_body, car_1_body_extension,car_1_back_wheel, car_1_front_wheel, car_1_front_wheel_extension,yaw_angle_text, steer_angle, steering_wheel,yaw_angle, Y_position, car_determined, Y_predicted, psi_predicted, car_predicted
    else:
        return car_1, car_1_body, car_1_body_extension,car_1_back_wheel, car_1_front_wheel, car_1_front_wheel_extension,yaw_angle_text, steer_angle, steering_wheel,yaw_angle, Y_position, car_determined
